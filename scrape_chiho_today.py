    ...
    try:
        ...
        for tr in table.find_all("tr"):
            ...
            try:
                ...
                rows.append({
                    "date": date_str, "race_id": race_id, "race_name": race_name,
                    "distance": distance, "馬番": umaban, "馬名": horse_name,
                    "斤量": weight, "騎手": jockey_name, "単勝": odds, "人気": pop
                })
            except Exception:
                continue
